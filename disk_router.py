...
class DiskRouterModule(tk.Frame):
    ...
    def setup_ui(self):
        ...
        queue_btn = tk.Button(form_frame, text="Queue Distress Call", bg="#1c2d3d", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.queue_drone_sector, width=22)
        queue_btn.pack(side=tk.LEFT, padx=5)
        
        rand_disk_btn = tk.Button(form_frame, text="🎲 Add 4 Random Incident Locations", bg="#1c2d3d", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.randomize_drone_targets)
        ...
        optimize_btn = tk.Button(action_row, text="⚡ Optimize Drone Response Flight ⚡", bg="#229954", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.execute_disk_scheduling)
        optimize_btn.pack(side=tk.LEFT, padx=5)
        
        view_math_btn = tk.Button(action_row, text="📊 View Analytical Flight Computations 📊", bg="#8e44ad", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.open_math_computation_page)
        view_math_btn.pack(side=tk.LEFT, padx=5)
        
        reset_router_btn = tk.Button(action_row, text="Reset Router", bg="#d35400", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.reset_drone_router)
