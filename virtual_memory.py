...
class VirtualMemoryModule(tk.Frame):
    ...
    def setup_ui(self):
        ...
        fetch_btn = tk.Button(form_frame, text="Fetch Incident Records", bg="#1c2d3d", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.access_virtual_page_suite, width=22)
        fetch_btn.pack(side=tk.LEFT, padx=5)
        
        rand_vm_btn = tk.Button(form_frame, text="Log 4 Random Calls", bg="#1c2d3d", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.randomize_vm_stream_suite)
        ...
        matrix_btn = tk.Button(action_row, text="📊 Open 911 Databank Analytics Matrix 📊", bg="#8e44ad", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.open_paging_analytics_page)
        matrix_btn.pack(side=tk.LEFT, padx=5)
        
        wipe_btn = tk.Button(action_row, text="Wipe Core Cache Server Data", bg="#d35400", fg="white", font=("Courier", 9, "bold"), relief="flat", bd=0, command=self.clear_vm_simulation)
